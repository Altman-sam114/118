...
- Gallery：生成结果查看、过滤、复用入口，筛选栏、Sort menu、图块、详情参数/操作和 Organization 控件支持大字号可读布局、图块 label/value 拆分语义、筛选栏和图块 pointer hover affordance、当前值、草稿/已保存 tags 和清晰操作语义。
