...
- Root：iPhone 使用 compact TabView；iPad 使用单层 NavigationSplitView，sidebar 行保持真实文本和 SF Symbol，Plan 入口使用中性 planning/checklist 图标而不是 payment-coded 图标，提供 selected/not-selected 辅助功能值、workspace hint、44pt 最小触控高度和系统 pointer hover affordance。
