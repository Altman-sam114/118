...
flowchart TD
  ...
  UI --> MODELUI["Models：下载 / 导入 / 删除 / 空状态 no-model/no-untracked 语义 / Add Model 键盘提交 / 未跟踪文件操作语义 / Storage Matrix VoiceOver 摘要 / Add Model error row / 带模型名上下文的 controls / 列表和详情 message rows"]
