...
flowchart TD
  ...
  NAV --> PLANUI["Plan：compact Form / iPad 双栏 / panel heading 和 note 语义 / 可访问状态徽章和 note rows / 能力矩阵 Paid candidates Planning only / entitlement rules / availability hints 含 Paid candidates Planning only 与 Mac app Not enabled / Mac readiness"]
