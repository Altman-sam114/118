...
flowchart TD
  ...
  UI --> MODELUI["Models：下载 / 导入 / 删除 / Storage Matrix VoiceOver 摘要 / Add Model error row / 可访问 controls / 列表和详情 message rows"]
...
```mermaid
flowchart TD
  A["用户打开 Models：Storage Matrix 摘要 / 可访问控件 / 大字号堆叠"] --> B{"模型来源"}
